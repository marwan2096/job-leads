<x-app-layout>
    ...
    <div class="py-12">
        <div class="bg-black shadow-lg rounded-lg p-6 max-w-7xl mx-auto">
            <a href="{{ route('dashboard') }}" class="text-indigo-400 hover:underline mb-6 inline-block">
                ← Back to Jobs
            </a>

            <div class="border-b border-white pb-6 mt-3">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <a href="{{ route('vacancy.apply', $jobVacancy->id) }}"
                            class="bg-gradient-to-r from-indigo-500 to-rose-500 text-white rounded-lg px-4 py-2 transition hover:from-indigo-600 hover:to-rose-600">
                            Apply Now
                        </a>
                    </div>
                </div>
