  ...
  {{-- 'title',
        ...
        'company_id', --}}
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="salary" value="{{ old('salary',$vacancy->salary) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm">
                        <x-input-error :messages="$errors->get('salary')" class="mt-2" />
                            <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1">description</label>
                        <textarea name="description" rows="4"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm">{{ old('description',$vacancy->description) }}</textarea>
    ...
    <label class="block text-sm font-medium text-gray-700 mb-1 mt-4">type</label>
       ...
       <option value="" disabled {{ old('type', $vacancy->type) ? '' : 'selected' }}>Select Type</option>
